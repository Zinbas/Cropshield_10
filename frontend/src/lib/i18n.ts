...
const copy: Record<LanguageCode, Copy> = {
  en: {
    home: "Home", crops: "My Crops", scan: "Scan", scans: "Scans", cases: "Cases", risks: "Alerts", more: "More", profile: "Profile", experts: "Experts", stores: "Stores", farmers: "Farmers", analytics: "Analytics",
    ...
    humidity: "Humidity", precipitation: "Precipitation", wind: "Wind", weatherUnavailable: "Weather is temporarily unavailable.",
  },
  hi: {
    home: "होम", crops: "मेरी फसलें", scan: "स्कैन", scans: "स्कैन", cases: "केस", risks: "अलर्ट", more: "और", profile: "प्रोफ़ाइल", experts: "विशेषज्ञ", stores: "दुकानें", farmers: "किसान", analytics: "विश्लेषण", save: "सहेजें", back: "वापस", language: "भाषा", welcome: "आप किस रूप में साइन इन कर रहे हैं?", signIn: "CropShield में साइन इन करें", create: "खाता बनाएं",
    ...
    humidity: "नमी", precipitation: "वर्षा", wind: "हवा", weatherUnavailable: "मौसम की जानकारी अस्थायी रूप से अनुपलब्ध है।",
  },
  mr: {
    home: "मुख्यपृष्ठ", crops: "माझी पिके", scan: "स्कॅन", scans: "स्कॅन", cases: "प्रकरणे", risks: "इशारे", more: "अधिक", profile: "प्रोफाइल", experts: "तज्ज्ञ", stores: "दुकाने", farmers: "शेतकरी", analytics: "विश्लेषण", save: "जतन करा", back: "मागे", language: "भाषा", welcome: "तुम्ही कोण म्हणून साइन इन करत आहात?", signIn: "CropShield मध्ये साइन इन करा", create: "खाते तयार करा",
    ...
    humidity: "आर्द्रता", precipitation: "पाऊस", wind: "वारा", weatherUnavailable: "हवामानाची माहिती तात्पुरती अनुपलब्ध आहे.",
  },
  as: {
    home: "হোম", crops: "মোৰ শস্য", scan: "স্কেন", scans: "স্কেন", cases: "কেছ", risks: "সতৰ্কতা", more: "অধিক", profile: "প্ৰফাইল", experts: "বিশেষজ্ঞ", stores: "দোকান", farmers: "কৃষক", analytics: "বিশ্লেষণ", save: "সংৰক্ষণ", back: "উভতি যাওক", language: "ভাষা", welcome: "আপুনি কোন হিচাপে ছাইন ইন কৰিছে?", signIn: "CropShield-ত ছাইন ইন কৰক", create: "একাউণ্ট সৃষ্টি কৰক",
    ...
    humidity: "আৰ্দ্ৰতা", precipitation: "বৰষুণ", wind: "বতাহ", weatherUnavailable: "বতৰৰ তথ্য সাময়িকভাৱে উপলব্ধ নহয়।",
  },
  bn: {
    home: "হোম", crops: "আমার ফসল", scan: "স্ক্যান", scans: "স্ক্যান", cases: "কেস", risks: "সতর্কবার্তা", more: "আরও", profile: "প্রোফাইল", experts: "বিশেষজ্ঞ", stores: "দোকান", farmers: "কৃষক", analytics: "বিশ্লেষণ", save: "সংরক্ষণ", back: "পিছনে", language: "ভাষা", welcome: "আপনি কী হিসেবে সাইন ইন করছেন?", signIn: "CropShield-এ সাইন ইন করুন", create: "অ্যাকাউন্ট তৈরি করুন",
    ...
    humidity: "আর্দ্রতা", precipitation: "বৃষ্টিপাত", wind: "বাতাস", weatherUnavailable: "আবহাওয়ার তথ্য সাময়িকভাবে অনুপলব্ধ।",
  },
};
