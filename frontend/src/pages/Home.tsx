...
export function getPrimaryMobileSectionIds(role: Role): Section[] {
  return role === "farmer" ? ["dashboard", "crops", "scans", "cases"] : ["dashboard", "scans", "cases", "farmers"];
}
